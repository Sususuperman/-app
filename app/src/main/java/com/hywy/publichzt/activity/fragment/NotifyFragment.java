...
public class NotifyFragment extends Fragment implements FlexibleAdapter.OnItemClickListener {
    ...
    private void initData() {
        ...
        Task task = null;
        task = new GetNotifyListTask(getActivity());
    ...
    public boolean onItemClick(int position) {
        ...
        NotifyDetailsActivity.startAction(getActivity(), notify);
